...
\twocolumn[
  \begin{@twocolumnfalse}
    ...
    37 Coq files, 199 theorems, every one machine-checked. Every claim below
...
\item \texttt{make verify} --- compiles all 37 \texttt{formal/*.v} files via
\texttt{coqc} in dependency order and runs \texttt{Print Assumptions} on every named
theorem (199 total), printing a tier report (\texttt{Th\_coqc} / \texttt{+reals} per
file).
