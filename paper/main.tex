...
\twocolumn[
  \begin{@twocolumnfalse}
    ...
    40 Coq files, 186 theorems, every one machine-checked. Every claim below
...
bound $\lambda\le 4-F_{\min}$ (machine-checked elsewhere in this repository) to a concrete
...
The Anderson--Morley eigenvalue ceiling (Anderson \& Morley, 1985) is now
