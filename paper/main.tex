...
\twocolumn[
  \begin{@twocolumnfalse}
    ...
    58 Coq files, 376 theorems (365 axiom-free \texttt{Th\_coqc}, 11 \texttt{+reals}),
...
\item \texttt{make verify} --- compiles all 58 \texttt{formal/*.v} files via
\texttt{coqc} in dependency order and runs \texttt{Print Assumptions} on every named
theorem (376 total: 365 \texttt{Th\_coqc}, 11 \texttt{+reals}), printing a tier report
