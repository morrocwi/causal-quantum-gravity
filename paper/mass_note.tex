...
\midrule
\multicolumn{3}{@{}l}{Totals: twenty Tier-0 files, $157$ closed checks; two \Tone{} files, $6$ checks} & $163$ & \\
\bottomrule
\end{tabularx}
...
files at commit \code{49945bd71b05}; the sharp-ceiling file postdates the pinned
commit, its hash is of the delivered source, pending synchronization. Each file is standalone; each compiled
